...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://postgres:111111@localhost:5433/nomadgram'),
}
...
THIRD_PARTY_APPS = [
    ...
    'taggit', #Tags tor the photos
]
LOCAL_APPS = [
    'nomadgram.users.apps.UsersAppConfig',
    # Your stuff: custom apps go here
    'nomadgram.images.apps.ImagesConfig',
    'nomadgram.notifications.apps.NotificationsConfig' # notfications app
]
